...
public class TweetController {
    ...
    private static final String CREATE_TWEET_TOPIC = "create_tweet_topic";
    @Autowired
    ...
    public void postTweet(@RequestBody Tweet tweet) {
        ...
        kafkaProducer.send(new ProducerRecord<>(CREATE_TWEET_TOPIC, String.valueOf(tweet.getId()), convertToJson(tweet)));
    }
